            ...
            <div className="d-flex justify-content-center">
              <div className="card card-width p-0">
                ...
                <div className="card-body">
                  ...
                  <form method="post" onSubmit={changePassword}>
                    <div className="row">
                      ...
                      <div className="mb-3 col-12">
                        <label
                          className="form-label"
                          htmlFor="user_account_password2"
                        >
                          Confirm password
                        </label>
                        <input
                  ...
                  {result.success && (
                    <span className="text-success">Change password done</span>
                  )}
                  {result.error && (
                    <span className="text-danger">Token not found!</span>
                  )}
                </div>
              </div>
            </div>
