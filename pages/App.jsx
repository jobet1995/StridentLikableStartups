          ...
          <nav id="sidebar">
            ...
            <ul className="list-unstyled">
              <li>
                <Link
                  to="/home"
                  className={path.endsWith("/home") ? "active bg-primary" : ""}
                >
                  Home
                </Link>
              </li>
              {user &&
                user.menu.map((menu, index) => (
                  <li key={index}>
                    <Link
                      to={`/${menu.path}`}
                      className={
                        path.substr(1).split("/")[0] == menu.path
                          ? "active bg-primary"
                          : ""
                      }
                    >
                ...
                <ul className="navbar-nav ms-auto">
                  <li id="searchbar_toggle_menu" className="d-none">
                    <a className="nav-link text-secondary" href="#">
                      <label htmlFor="searchbar_toggle" className="d-lg-none">
