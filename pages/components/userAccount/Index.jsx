      ...
      <div className="row">
        <div className="col">
          <div className="col-12">
            ...
            <div id="searchbar" className="mb-4">
              <div className="form-group col-lg-2 me-2 mb-lg-0 mb-3">
                ...
                >
                  ...
                  <option value="UserAccount.active">
                    User Account Active
                  </option>
                </select>
              </div>
            ...
            <table className="table table-sm table-striped table-hover">
              <thead>
                <tr>
                  ...
                  <th
                    className={
                      Util.getSortClass("UserAccount.email") +
                      " d-none d-md-table-cell"
                    }
                  >
                    <Link
                      to={Util.getLink(paging, "sort", "UserAccount.email")}
                    >
                      Email
                    </Link>
                  </th>
                  <th className={Util.getSortClass("UserAccount.active")}>
                    <Link
                      to={Util.getLink(paging, "sort", "UserAccount.active")}
                    >
                      Active
                    </Link>
                  </th>
            ...
            <Link className="btn btn-sm btn-primary" to="/userAccount/create">
              Create
            </Link>
          </div>
          <style
