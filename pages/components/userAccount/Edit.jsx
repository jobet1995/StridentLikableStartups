          ...
          <form method="post" onSubmit={edit}>
            <div className="row">
              <div className="mb-3 col-md-6 col-lg-4">
                <label className="form-label" htmlFor="user_account_id">
                  Id
                </label>
                <input
                  readOnly
              ...
              <div className="mb-3 col-md-6 col-lg-4">
                <label className="form-label" htmlFor="user_account_name">
                  Name
                </label>
                <input
              ...
              <div className="mb-3 col-md-6 col-lg-4">
                <label className="form-label" htmlFor="user_account_email">
                  Email
                </label>
                <input
              ...
              <div className="mb-3 col-md-6 col-lg-4">
                <label className="form-label" htmlFor="user_account_password">
                  Password
                </label>
                <input
              ...
              <div className="mb-3 col-md-6 col-lg-4">
                <label className="form-label" htmlFor="user_account_password2">
                  Confirm password
                </label>
                <input
              ...
              <div className="form-check col-md-6 col-lg-4">
                ...
                <label
                  ...
                  htmlFor="user_account_active"
                >
                  Active
                </label>
                {errors.active && (
                  <span className="text-danger">{errors.active}</span>
                )}
              </div>
              <div className="col-12">
                ...
                {roles.map((role, index) => (
                  <div key={index} className="form-check">
                    ...
                    <label
                      className="form-check-label"
                      htmlFor={`user_role_role_id${role.id}`}
                    >
                      {role.name}
                    </label>
                  </div>
